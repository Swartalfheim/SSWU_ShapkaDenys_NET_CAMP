...
namespace Task
{// Оскільки Ви не реалізували ніякого інтерфейсу для менеджера, то він у Вас залишається конкретним класом. тому програма жорстко зав'язана на консольній подачі.
// треба створити інтерфейс і віднього наслідувати цей клас, а в основній програмі створити екземпляр цього класу через інтерфейс.
    public class SimulatorManager
    {// У Вас менеджер керує, коли зупиняти процес симуляції, тому тут мають бути події, а реакції на них мають бути в модельному класі.
